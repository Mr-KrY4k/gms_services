/// Логгер для плагина gms_services.
///
...
class _CustomLogPrinter extends logger_pkg.LogPrinter {
  static const String _prefix = '[gms_services]';
...
/// ```dart
/// GmsLogger.debug('Начало настройки');
/// GmsLogger.info('Успешно добавлен плагин');
/// GmsLogger.warning('Файл уже содержит настройки');
/// GmsLogger.error('Ошибка при чтении файла', error: e, stackTrace: s);
/// ```
class GmsLogger {
  GmsLogger._();
